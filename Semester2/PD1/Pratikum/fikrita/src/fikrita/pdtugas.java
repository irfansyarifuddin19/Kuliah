 ...
 * @author Irfan
 */
public class pdtugas {
    public static void main(String[] args) {
        int pilihan, kode, hari = 0, pilih_menu, index, pilih_sub, menu_sopir, indek = 0, index_laporan = 0,mobil_kembali,k =0,s=0,z=0;
        ...
        do {
            ...
            switch (pilihan) {
                ...
                case 3 :
                    ...
                    for (int i = 0; i < kode_sopir.length; i++) {
                        ...
                        if (kode_sopir[i] != null) {
                            if (kode_sopir[i].equalsIgnoreCase(pilih_sopir)) {
                                ...
                                if (laporan[index_laporan][1] == nama_sopir) {
                                }
                   ...
                   } while (laporan[index_laporan][1] == nama_sopir);
                   ...
                   do {
                    ...
                    kode = input.nextInt();
                    if (laporan[index_laporan][2] == mobil[kode-1]) {
                        System.out.println("mobil sudah di sewa");
                    }
                   }while (laporan[index_laporan][2]==mobil[kode-1]);
                ...
                laporan[index_laporan][0] = booking;
                laporan[index_laporan][1] = nama_sopir;
                laporan[index_laporan][2] = mobil[kode-1];
